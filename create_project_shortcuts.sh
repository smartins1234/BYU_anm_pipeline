...
icon -n "${nickname}aya" ${PROJECT_NAME} ${PROJECT_PATH} Maya pipe/tools/_resources/dcc-maya-icon.png launch/maya.sh
icon -n "${nickname}ini" ${PROJECT_NAME} ${PROJECT_PATH} Houdini pipe/tools/_resources/dcc-houdini-icon.png launch/hou.sh
